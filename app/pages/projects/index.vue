...
<template>
  <div class="h-screen overflow-clip flex flex-col">
    ...
    <div ref="scrollContainer"
      class="min-h-0 w-full grow flex px-8 lg:px-16 2xl:px-20 overflow-y-scroll scrollbar-hide">
      ...
      <ScrollSnap v-else ref="scrollSnapRef" :key="scrollSnapKey"
        ...
        <Waterfall :items="filteredPlaygrounds" class="mt-6" :key="`playgrounds-${filteredPlaygrounds.length}`" />
      </ScrollSnap>
